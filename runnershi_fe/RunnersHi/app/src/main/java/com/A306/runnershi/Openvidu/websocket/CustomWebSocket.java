package com.A306.runnershi.Openvidu.websocket;
...
public class CustomWebSocket extends AsyncTask<MainActivity, Void, Void> implements WebSocketListener {
...
//            activity.viewToConnectedState();
    ...
    public void joinRoom() {
        ...
        joinRoomParams.put("serverData", "ServerData");
...
//        this.activity.createRemoteParticipantVideo(remoteParticipant);
    ...
    public void onStateChanged(WebSocket websocket, WebSocketState newState) throws Exception {
        Timber.i("State changed: " + newState.name());
    }
    ...
    public void onDisconnected(WebSocket websocket, WebSocketFrame
        ...
        Timber.e("Disconnected " + serverCloseFrame.getCloseReason() + " " + clientCloseFrame.getCloseReason() + " " + closedByServer);
    }
    ...
    public void onBinaryFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        Timber.i("Binary Frame");
    }

    @Override
    public void onCloseFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        Timber.i("Close Frame");
    }
    ...
    @Override
    protected Void doInBackground(MainActivity... sessionActivities) {
        try {
            ...
            Timber.e(factory.toString());
            Timber.e("웹소켓 생성");
            Timber.e(getWebSocketAddress(openviduUrl));
    ...
    protected void onProgressUpdate(Void... progress) {
        Timber.i("PROGRESS " + Arrays.toString(progress));
    }
