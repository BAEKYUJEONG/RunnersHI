package com.A306.runnershi.Openvidu.constant;

public final class JsonConstants {

    public static final String OPENVIDU_URL = "https://k4a3061.p.ssafy.io/";
    public static final String OPENVIDU_SECRET = "MY_SECRET";
