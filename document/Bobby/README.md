...
## 2021.05.03 카카오 로그인 완료, 데이터 센서 세팅

### 카카오 로그인 완료

카카오에서 제공하는 대로 로그인을 완료했습니다. 로그인 시 페이지 이동을 하며 데이터 전송은 추후 서버가 세팅되는대로 마무리 할 예정입니다.

### 데이터 센서 세팅

데이터 센서 접근 이후 데이터 받아오기, 데이터 테스트를 진행할 예정입니다.
