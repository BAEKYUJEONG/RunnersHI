...
public class FriendController {
  ...
  public ResponseEntity<String> addFriendTest(@PathVariable String userId1,
      @PathVariable String userId2, HttpServletRequest req) {
    return new ResponseEntity<String>(friendService.addFriendTest(userId1, userId2), HttpStatus.OK);
  }
